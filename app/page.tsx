    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="max-w-screen-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <MetricCard label="Total Liquidations" value={formatUSD(c?.liquidations?.total24h || 0)} subValue={c ? `L: ${formatUSD(c.liquidations.longs24h)} / S: ${formatUSD(c.liquidations.shorts24h)}` : undefined} loading={loading} />
