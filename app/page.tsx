...
/>
        ...
        <div style={{ textAlign: 'center', padding: '12px 0 4px', fontSize: 11, color: 'var(--text-muted)' }}>
          Derivatives & Funding: Coinalyze · ETF Flows: Farside Investors · ETF AUM: Farside / CoinGlass · Stablecoins & RWA: DefiLlama · Strategy: CoinGecko · Spot & Global: CoinGecko · Skew, Basis & Options OI: Deribit · Sentiment: CoinMarketCap
        </div>
